...
aiStudio=function(){
 ...
 let bots=v21AvailableAiBots().filter(b=>(v21AiState.category==='すべて'||b.category===v21AiState.category)&&(!q||(b.name+b.category+b.desc).toLowerCase().includes(q))&&(!v21AiState.favoritesOnly||favs.includes(b.id)));
